...
namespace HatFeather.Shared.CharacterControl
{
    ...
    public class FirstPersonMotionController : MonoBehaviour
    {
        ...
        [SerializeField] FirstPersonMotionInput m_Input = null;

        [Header("Motion")]
        [SerializeField] SpeedDefinition m_Speed = SpeedDefinition.Default;
        ...
        [Space]
        [SerializeField] string[] m_SlideTags = null;
        ...
        { get { return Mathf.Abs(m_Input.horizontal.AxisRaw) + Mathf.Abs(m_Input.vertical.AxisRaw) > MIN_RECOGNIZED_MOVE_INPUT; } }
        ...
        public event System.Action setNewParent;
        ...
        {
            Vector3 motion;
            Vector2 input = new Vector2(m_Input.horizontal.AxisRaw, m_Input.vertical.AxisRaw);
            if (m_IsGrounded)
            {
                if (m_IsSliding)
